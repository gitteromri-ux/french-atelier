    ...
    courses: [
      {
        ...
        pins: [
          ...
          { id: "bakery-16", city: "Paris — Passy", lat: 48.8580, lng: 2.2780, location: "Boulangerie in the 16th arrondissement", image: "assets/img/mapstr/bakery-16.webp", credit: "Photo: The Now Time / Unsplash", photoSrc: "https://unsplash.com/photos/a-building-with-a-sign-that-says-boulangere-house-71lofi-Y1No", units: [{ num: 2, fr: "Épeler & vérifier une information", en: "Ask how to spell a word, spell it back, and confirm or correct. Practice the French alphabet and phonetics." }] },
          ...
          { id: "coulee-verte", city: "Paris — Coulée Verte", lat: 48.8488, lng: 2.3846, location: "Coulée Verte René-Dumont (elevated park), 12e arrondissement", image: "assets/img/mapstr/coulee-verte.webp", credit: "Photo: Mattyas Lamar / Unsplash", photoSrc: "https://unsplash.com/photos/a-city-street-filled-with-lots-of-tall-buildings-3BFbEErKSwE", units: [{ num: 14, fr: "Gérer un imprévu", en: "Handle an unexpected situation (a closed venue), propose an alternative plan, and make a decision." }, { num: 15, fr: "Fixer un rendez-vous (date / heure)", en: "Propose a time and date, negotiate with ça va ?, confirm and close. Tell the time and days of the week." }] },
      ...
      },
      {
        ...
        pins: [
          ...
          { id: "contrescarpe", city: "Paris — Place de la Contrescarpe", lat: 48.8508, lng: 2.3506, location: "Place de la Contrescarpe, 5e arrondissement (Hemingway's Paris)", image: "assets/img/mapstr/contrescarpe.webp", credit: "Photo: Alex Harmuth / Unsplash", photoSrc: "https://unsplash.com/photos/people-sitting-on-chair-near-building-during-daytime-bOICdD-Gulk", units: [{ num: 11, fr: "Proposer une activité (14 juillet) + se mettre d'accord", en: "Suggest Bastille Day activities: on va voir le feu d'artifice / on va au bal, negotiate a time and confirm." }] },
      ...
      },
      {
        ...
        pins: [
          ...
          { id: "la-rhune", city: "La Rhune", lat: 43.3088, lng: -1.6353, location: "La Rhune (sacred Basque mountain, 905m, rack railway to the summit)", image: "assets/img/mapstr/la-rhune.webp", credit: "Photo: Sébastien Vincon / Pexels", photoSrc: "https://www.pexels.com/photo/gypsy-horses-in-the-mountain-9360229/", units: [{ num: 19, fr: "Micro-récit + réagir / relancer (pré-bilan)", en: "Narrate a recent outing in 4 sentences, express a nuanced reaction j'ai adoré / j'ai pas trop aimé." }] },
      ...
      },
      {
        ...
        pins: [
          ...
          { id: "place-erlon", city: "Reims — Place d'Erlon", lat: 49.2580, lng: 4.0321, location: "Place d'Erlon (Reims's lively pedestrian main square, cafés and brasseries)", image: "assets/img/mapstr/place-erlon.webp", credit: "Photo: Adlan / Unsplash", photoSrc: "https://unsplash.com/photos/brown-concrete-building-during-daytime-eyMN10SJZoM", units: [{ num: 18, fr: "Signaler un problème + demander une solution", en: "Signal a problem at a restaurant or shop calmly, request a remedy, and conclude the interaction once the issue is resolved." }] },
      ...
      },
      {
        ...
        pins: [
          ...
          { id: "lsf-el-admin", city: "Paris — Bureau de poste", lat: 48.8654, lng: 2.3489, location: "Bureau de poste (La Poste branch), 2e arrondissement — administrative tasks at bank or post office", image: "assets/img/mapstr/lsf-el-admin.webp", credit: "Photo: Kirandeep Singh Walia / Pexels", photoSrc: "https://www.pexels.com/photo/view-of-street-and-buildings-of-paris-france-16938779/", units: [{ num: 8, fr: "Vie pratique", en: "Handle a simple administrative task at a bank or post office: state your request in formal register, understand the procedure, and write a short 2–3 sentence complaint message." }] },
