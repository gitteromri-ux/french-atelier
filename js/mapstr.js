    ...
    courses: [
      {
        ...
        pins: [
          { id: "eiffel", city: "Paris — Tour Eiffel", lat: 48.8584, lng: 2.2945, location: "Eiffel Tower & Champ-de-Mars, 7e arrondissement", image: "assets/img/mapstr/eiffel.jpg", credit: "Photo: NonOmnisMoriar / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 1, fr: "Se présenter", en: "Greet, exchange names, discover the cultural codes of first meetings in French. Use s'appeler and propose tu." }] },
          { id: "alma-cafe", city: "Paris — Alma Bridge", lat: 48.8630, lng: 2.3010, location: "Classic café near the Alma bridge, 8e arrondissement", image: "assets/img/mapstr/alma-cafe.jpg", credit: "Photo: Joe deSousa / Wikimedia Commons (CC0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 3, fr: "Demander son chemin", en: "Use excusez-moi and c'est où ? to ask for directions. Understand left, right, straight on." }, { num: 4, fr: "Réparer + commander une boisson simple", en: "Signal a communication breakdown, ask for repetition or slower speech, and place a simple café order." }] },
          ...
          { id: "bouillon-chartier", city: "Paris — Bouillon Chartier", lat: 48.8742, lng: 2.3460, location: "Bouillon Chartier, 9e arrondissement (Grands Boulevards)", image: "assets/img/mapstr/bouillon-chartier.jpg", credit: "Photo: Benoît Prieur / Wikimedia Commons (CC0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 5, fr: "Commander — Je voudrais… + c'est combien ?", en: "Order food and drinks using je voudrais, ask for the price, handle numbers 0–39. French restaurant culture." }, { num: 6, fr: "Commander — Autre chose ?", en: "Respond to Autre chose ? and C'est tout ?, add items to an order, practice numbers 40–69." }, { num: 10, fr: "Commander — Payer par carte", en: "Express hunger and thirst with j'ai faim / soif, place an order, and pay by card. Full café interaction." }] },
          { id: "palais-royal", city: "Paris — Palais-Royal", lat: 48.8638, lng: 2.3371, location: "Palais-Royal gardens & Tuileries, 1er arrondissement", image: "assets/img/mapstr/palais-royal.jpg", credit: "Photo: Jeanne Menjoulet from Paris, France / Wikimedia Commons (CC BY 2.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 7, fr: "Proposer une sortie simple", en: "Use être and the pronoun y to suggest an outing, accept or decline, and make a simple decision." }, { num: 8, fr: "Accepter / refuser + exprimer une préférence", en: "Use je préfère to choose between two options, accept or refuse politely, reach a clear decision." }] },
          { id: "pont-des-arts", city: "Paris — Pont des Arts", lat: 48.8584, lng: 2.3375, location: "Pont des Arts (Love Lock Bridge), 6e arrondissement", image: "assets/img/mapstr/pont-des-arts.jpg", credit: "Photo: Benh LIEU SONG / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 9, fr: "Échanger un numéro de téléphone", en: "Ask for and give a phone number, verify with c'est..., c'est ça ?, practice numbers 70–99." }] },
          { id: "pantheon", city: "Paris — Panthéon", lat: 48.8462, lng: 2.3510, location: "Panthéon, 5e arrondissement (Latin Quarter)", image: "assets/img/mapstr/pantheon.jpg", credit: "Photo: Nick Loyless from Dallas, TX, United States / Wikimedia Commons (CC BY 2.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 11, fr: "Acheter un billet / demander un prix", en: "Buy a ticket, ask for the price, and pay. Cultural role of museums and cultural venues in France." }] },
          { id: "jardin-luxembourg", city: "Paris — Jardin du Luxembourg", lat: 48.8462, lng: 2.3372, location: "Jardin du Luxembourg & Shakespeare & Co, 6e arrondissement", image: "assets/img/mapstr/jardin-luxembourg.jpg", credit: "Photo: Jorge Láscar from Melbourne, Australia / Wikimedia Commons (CC BY 2.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 12, fr: "Donner / échanger email & adresse", en: "Exchange email addresses and street addresses using possessive adjectives mon, ma. Spell and confirm details." }, { num: 13, fr: "Parler de son origine / où on habite", en: "Use venir de and habiter à to talk about where you are from and where you live. Introduce a third person." }] },
          ...
          { id: "bastille", city: "Paris — Bastille", lat: 48.8533, lng: 2.3692, location: "Place de la Bastille, 11e/12e arrondissement", image: "assets/img/mapstr/bastille.jpg", credit: "Photo: Florian Pépellin / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 16, fr: "Commander — Réactivation", en: "Revisit ordering sequences at a faster pace: respond to Autre chose ? in three different ways." }, { num: 17, fr: "Commander — Je prends… + l'addition", en: "Use je prends, react to an unavailable item, and ask for the bill. Fluent end-to-end restaurant interaction." }] },
          { id: "montmartre", city: "Paris — Montmartre", lat: 48.8867, lng: 2.3431, location: "Montmartre & Place du Tertre, 18e arrondissement", image: "assets/img/mapstr/montmartre.jpg", credit: "Photo: Taxiarchos228 / Wikimedia Commons (CC BY 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 18, fr: "Exprimer une préférence + justifier", en: "Choose between two options, say je préfère…, and justify with parce que c'est + adjectif." }] },
          { id: "canal-saint-martin", city: "Paris — Canal Saint-Martin", lat: 48.8695, lng: 2.3652, location: "Canal Saint-Martin, 10e arrondissement", image: "assets/img/mapstr/canal-saint-martin.jpg", credit: "Photo: Superbass / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 19, fr: "Arrivée — Se présenter + orientation + réparation", en: "Chain two micro-tasks — introducing yourself and asking for directions — with repair if needed. Review of Units 1–3." }, { num: 20, fr: "Commander + payer + réparer + conclure", en: "Complete a full ordering and payment scenario at speed. Closing review of FA Foundation. A true production milestone." }] }
        ],
      ...
      },
      {
        ...
        pins: [
          ...
          { id: "rouen", city: "Rouen", lat: 49.4432, lng: 1.0993, location: "Vieux-Marché & half-timbered streets, Rouen (Joan of Arc's city)", image: "assets/img/mapstr/rouen.webp", credit: "Photo: DimiTalen / Wikimedia Commons (CC0)", photoSrc: "https://unsplash.com/photos/a-large-clock-mounted-to-the-side-of-a-building-n5YqDkfbnaU", units: [{ num: 7, fr: "Demander poliment / s'excuser + réparer", en: "Use polite formulas and repair strategies: vous pouvez répéter ? / parler plus lentement ?" }, { num: 8, fr: "Localiser : dire où est… (c'est / il y a)", en: "Use c'est and il y a to describe location: give a street, number, and distances près d'ici / loin." }] },
          { id: "etretat", city: "Étretat", lat: 49.7070, lng: 0.2046, location: "Falaise d'Aval (chalk cliffs immortalised by Monet & Maupassant), Étretat", image: "assets/img/mapstr/etretat.jpg", credit: "Photo: Jörg Braukmann / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 9, fr: "Décrire ce qu'on voit + donner un avis simple", en: "Describe three elements using c'est un/une…, il y a…, je vois… and express a simple opinion." }, { num: 13, fr: "Parler de la météo + réagir", en: "Ask and answer about the weather: il fait beau / froid / chaud, il pleut, predict with demain, il va faire…" }] },
          { id: "versailles", city: "Versailles", lat: 48.8049, lng: 2.1204, location: "Palace of Versailles & Hall of Mirrors, Versailles", image: "assets/img/mapstr/versailles.webp", credit: "Photo: Myrabella / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "https://unsplash.com/photos/a-large-room-with-a-chandelier-in-it-WMCvwBTWSi0", units: [{ num: 10, fr: "Fixer une date / heure + parler de projets (futur proche)", en: "Give the date and day, talk about plans using demain, je vais… and cette semaine, je vais…" }, { num: 14, fr: "Choisir / proposer une activité selon la météo", en: "Based on the weather, suggest two activities: on va au parc / au cinéma / au château." }] },
          { id: "contrescarpe", city: "Paris — Place de la Contrescarpe", lat: 48.8508, lng: 2.3506, location: "Place de la Contrescarpe, 5e arrondissement (Hemingway's Paris)", image: "assets/img/mapstr/contrescarpe.webp", credit: "Photo: Matt Casagrande from Somerville, MA / Wikimedia Commons (CC BY-SA 2.0)", photoSrc: "https://www.pexels.com/photo/charming-paris-cafe-in-historic-rue-des-ursins-39194165/", units: [{ num: 11, fr: "Proposer une activité (14 juillet) + se mettre d'accord", en: "Suggest Bastille Day activities: on va voir le feu d'artifice / on va au bal, negotiate a time and confirm." }] },
          { id: "jardin-plantes", city: "Paris — Jardin des Plantes", lat: 48.8435, lng: 2.3595, location: "Jardin des Plantes & Seine quays, 5e arrondissement", image: "assets/img/mapstr/jardin-plantes.webp", credit: "Photo: Alvesgaspar / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "https://unsplash.com/photos/a-large-building-with-a-garden-in-front-of-it-3OQlnv6fuso", units: [{ num: 12, fr: "Décrire ses routines + négation utile", en: "Talk about daily routine with reflexive verbs je me lève à… and negate habits je ne travaille pas le week-end." }, { num: 15, fr: "Parler d'activités (verbes en -ER) + organiser une sortie", en: "Use common -er verbs to describe leisure activities, plan a museum or expo outing, arrange a meeting point." }] },
          ...
          { id: "train-bleu", city: "Paris — Gare de Lyon", lat: 48.8449, lng: 2.3739, location: "Le Train Bleu restaurant, Gare de Lyon, 12e arrondissement", image: "assets/img/mapstr/train-bleu.jpg", credit: "Photo: kkmarais / Wikimedia Commons (CC BY 2.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 18, fr: "Parler de ce qu'on mange / boit + préférences", en: "Discuss food and drink habits: je mange…, je bois…, offer or decline with tu en veux ? / oui, volontiers !" }] },
      ...
      },
      {
        ...
        pins: [
          ...
          { id: "chenonceau", city: "Château de Chenonceau", lat: 47.3238, lng: 1.0701, location: "Château de Chenonceau (the château of the ladies, spanning the Cher river)", image: "assets/img/mapstr/chenonceau.jpg", credit: "Photo: Wladyslaw (talk) / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 4, fr: "Demander et indiquer une direction (reprise + pression)", en: "Ask for two different locations and give two complete directions. Practice at a faster pace." }, { num: 5, fr: "Proposer une mini-sortie + se mettre d'accord", en: "Plan a short outing: suggest a meeting point on se retrouve à…, sequence two activities, confirm ça marche !" }] },
          { id: "tours", city: "Tours", lat: 47.3941, lng: 0.6848, location: "Place Plumereau terraces & Loire guinguette, Tours", image: "assets/img/mapstr/tours.jpg", credit: "Photo: Tilman2007 / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 6, fr: "Commander au bar / restaurant (poliment)", en: "Order two items using je voudrais…, s'il vous plaît, respond to a follow-up, ask for l'addition." }, { num: 7, fr: "Partager + exprimer une quantité (pronom en)", en: "Offer and respond to sharing using the pronoun en. Practise expressing quantity in a natural food-sharing context." }] },
          { id: "poitiers", city: "Poitiers", lat: 46.5802, lng: 0.3404, location: "Parc de Blossac, Poitiers (elegant park, gateway to the south)", image: "assets/img/mapstr/poitiers.jpg", credit: "Photo: Benoît Prieur / Wikimedia Commons (CC0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 9, fr: "Comparer + justifier (parce que / mais)", en: "Compare two options using je préfère… parce que…, introduce nuance with mais l'autre option est plus…" }, { num: 10, fr: "Exprimer ses goûts + justifier", en: "Share a cultural preference using j'aime bien… parce que…, invite the other person et toi, tu préfères quoi ?" }] },
          { id: "bordeaux-wine", city: "Bordeaux — Wine District", lat: 44.8405, lng: -0.5805, location: "Bordeaux wine merchants & vineyards, Chartrons district", image: "assets/img/mapstr/bordeaux-wine.jpg", credit: "Photo: Phillip Maiwald (Nikopol) / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 8, fr: "Recommander + exprimer une préférence", en: "Recommend a wine using je te conseille celui-là, ask tu préfères rouge ou blanc ? French wine culture." }] },
          { id: "cite-du-vin", city: "Bordeaux — Cité du Vin", lat: 44.8620, lng: -0.5545, location: "La Cité du Vin (the world's premier wine museum), Bordeaux", image: "assets/img/mapstr/cite-du-vin.jpg", credit: "Photo: Zairon / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 11, fr: "Proposer une sortie + se mettre d'accord", en: "Suggest a weekend outing: t'as envie de sortir ? on pourrait aller au musée ?, negotiate, fix time and place." }] },
          { id: "bordeaux-musee", city: "Bordeaux — Musée des Beaux-Arts", lat: 44.8387, lng: -0.5764, location: "Musée des Beaux-Arts de Bordeaux, Cours d'Albret", image: "assets/img/mapstr/bordeaux-musee.jpg", credit: "Photo: GFreihalter / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 14, fr: "Décrire une œuvre + exprimer une préférence", en: "Describe a work of art c'est un tableau / une sculpture using two adjectives, express a preference." }, { num: 15, fr: "Présenter une œuvre (mini-exposé) + justifier", en: "Give a structured 30–45 second presentation: je vais vous parler de…, c'est une œuvre de…, ça a été créé en…" }] },
          ...
          { id: "gujan-mestras", city: "Gujan-Mestras", lat: 44.6384, lng: -1.0672, location: "Oyster ports of Gujan-Mestras, Bassin d'Arcachon", image: "assets/img/mapstr/gujan-mestras.jpg", credit: "Photo: Franck-fnba / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 16, fr: "Organiser un parcours + se mettre d'accord", en: "Negotiate a visit itinerary: on commence par…, et ensuite…, asking for agreement t'es d'accord ?" }] },
          { id: "bayonne", city: "Bayonne", lat: 43.4929, lng: -1.4748, location: "Cathédrale Sainte-Marie & chocolate-makers of the old town, Bayonne", image: "assets/img/mapstr/bayonne.jpg", credit: "Photo: Daniel VILLAFRUELA / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 17, fr: "Raconter / imaginer (micro-récit)", en: "Narrate and imagine a scene using d'abord…, et ensuite…, à la fin… Produce a 4-sentence micro-narrative." }] },
          { id: "biarritz", city: "Biarritz", lat: 43.4832, lng: -1.5586, location: "Rocher de la Vierge, Biarritz (iconic Basque surf coast viewpoint)", image: "assets/img/mapstr/biarritz.jpg", credit: "Photo: Christian David / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 18, fr: "Organiser une visite (heure / lieu / étapes) + valider", en: "Plan a full visit: agree on meeting point on se retrouve à… heures devant…, sequence three stages." }] },
          ...
          { id: "saint-jean-luz", city: "Saint-Jean-de-Luz", lat: 43.3895, lng: -1.6612, location: "Harbour of Saint-Jean-de-Luz (where Louis XIV was married, final bay before Spain)", image: "assets/img/mapstr/saint-jean-luz.webp", credit: "Photo: Grand Parc - Bordeaux, France from France / Wikimedia Commons (CC BY 2.0)", photoSrc: "https://unsplash.com/photos/white-and-black-boat-on-sea-near-brown-building-during-daytime-sUM5WLQ1CnQ", units: [{ num: 20, fr: "Consolider : défendre un choix + négocier + conclure", en: "Defend a choice: moi, je choisis… parce que…, propose an alternative on pourrait aussi…, close allez, c'est décidé !" }] }
        ],
      ...
      },
      {
        ...
        pins: [
          { id: "vieux-port", city: "Marseille — Vieux-Port", lat: 43.2951, lng: 5.3700, location: "Vieux-Port (Old Harbour), Marseille — the beating heart of the city since 600 BC", image: "assets/img/mapstr/vieux-port.webp", credit: "Photo: Zairon / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://unsplash.com/photos/a-harbor-filled-with-lots-of-boats-next-to-a-city-w86Etj-p0wI", units: [{ num: 1, fr: "Inviter / proposer une sortie", en: "Invite someone out using et si on allait au théâtre ?, agree on a time and place, and confirm warmly in a spontaneous 10-turn exchange." }, { num: 2, fr: "Refuser poliment + proposer une alternative", en: "Decline an invitation with a brief reason and immediately offer a concrete alternative. Maintain tu/vous register throughout." }] },
          { id: "le-panier", city: "Marseille — Le Panier", lat: 43.2977, lng: 5.3683, location: "Le Panier (oldest quarter of Marseille), steep alleys and colourful facades above the port", image: "assets/img/mapstr/le-panier.webp", credit: "Photo: Lily from Tallinn / Wikimedia Commons (CC BY 2.0)", photoSrc: "https://unsplash.com/photos/green-plants-on-brown-concrete-stairs-Qn_ot1LHFng", units: [{ num: 3, fr: "Négocier + conclure un compromis", en: "Raise a constraint, propose a practical concession, and close with a clear joint decision. Practice structured negotiation over at least 12 turns." }, { num: 4, fr: "Exprimer une préférence culturelle + comparer", en: "Share a preference about social customs, justify it, and invite comparison — et dans ton pays, on fait comment ? Discover the cultural codes around la bise." }] },
          { id: "vallon-auffes", city: "Marseille — Vallon des Auffes", lat: 43.2837, lng: 5.3558, location: "Vallon des Auffes (tiny fishing harbour under the Corniche, Marseille)", image: "assets/img/mapstr/vallon-auffes.webp", credit: "Photo: Zairon / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://unsplash.com/photos/an-aerial-view-of-a-city-with-a-bridge-over-the-water-xpUKtP4MGus", units: [{ num: 5, fr: "Exprimer une gêne + demander conseil", en: "Express uncertainty about a social situation, ask for the other person's preference, and propose a comfortable alternative." }, { num: 6, fr: "Recommander + micro-récit au passé", en: "Open with a short past-tense anecdote, make a recommendation, justify it, introduce a nuance with en revanche, and invite the other person." }] },
          { id: "mucem", city: "Marseille — MuCEM", lat: 43.2966, lng: 5.3610, location: "MuCEM (Museum of European and Mediterranean Civilisations), J4 pier, Marseille", image: "assets/img/mapstr/mucem.webp", credit: "Photo: Rémih / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://unsplash.com/photos/a-building-with-a-large-glass-wall--GnlFtAkB9o", units: [{ num: 7, fr: "Donner un avis + voter entre deux options", en: "Share a personal opinion about a cultural event, justify it, compare two options, and reach a joint decision. Practice direct object pronouns." }, { num: 8, fr: "Donner un avis + comparer deux œuvres", en: "Express two opinions on works of art, compare them, and ask et toi, tu préfères lequel ? Discover key works of French art." }] },
          { id: "calanques", city: "Marseille — Calanques", lat: 43.2164, lng: 5.4386, location: "Calanques de Morgiou (limestone coastal inlets, Parc National des Calanques), south of Marseille", image: "assets/img/mapstr/calanques.webp", credit: "Photo: Rémih / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://unsplash.com/photos/a-body-of-water-surrounded-by-mountains-and-trees-YqKYEtwvofw", units: [{ num: 9, fr: "Organiser un parcours + gérer un imprévu", en: "Plan a three-stage visit, handle an unexpected closure, and agree on a plan B. Practice improvised decision-making in a cultural setting." }] },
          { id: "mer-de-glace", city: "Chamonix — Mer de Glace", lat: 45.9161, lng: 6.9210, location: "Mer de Glace (France's largest glacier, reached by the Montenvers rack railway), Chamonix", image: "assets/img/mapstr/mer-de-glace.webp", credit: "Photo: Tiia Monto / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "https://unsplash.com/photos/snow-covered-mountain-during-daytime-HcxDrovmZVo", units: [{ num: 10, fr: "Comparer + nuancer un avis", en: "Compare two cultural experiences, introduce nuance with mais / en revanche / au final, and state a clear personal preference. Explore the French performing arts scene." }, { num: 11, fr: "Recommander un endroit + se repérer", en: "Express a preference for a neighbourhood, handle a moment of disorientation, and make a local recommendation." }] },
          { id: "aiguille-du-midi", city: "Chamonix — Aiguille du Midi", lat: 45.8786, lng: 6.8873, location: "Aiguille du Midi (3,842 m cable-car summit, Chamonix — panoramic view over Mont-Blanc massif)", image: "assets/img/mapstr/aiguille-du-midi.webp", credit: "Photo: Gabriel from92 / Wikimedia Commons (CC0)", photoSrc: "https://unsplash.com/photos/a-snow-covered-mountain-with-a-clear-blue-sky-kepcDGM4HFY", units: [{ num: 12, fr: "Nuancer un avis + défendre un choix", en: "Assert a position, acknowledge the counterargument, and defend a practical decision using concessive connectors." }] },
          { id: "petite-france", city: "Strasbourg — Petite France", lat: 48.5800, lng: 7.7400, location: "Petite France (medieval half-timbered district on the Ill river), Strasbourg", image: "assets/img/mapstr/petite-france.webp", credit: "Photo: Ludvig14 / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://unsplash.com/photos/white-and-brown-concrete-building-beside-river-during-daytime-Cq4BqP4IYN4", units: [{ num: 13, fr: "Proposer + comparer deux destinations", en: "Propose two travel destinations, compare them on one criterion, justify your preference, and reach a joint decision. Practice French regional vocabulary." }] },
          { id: "place-broglie", city: "Strasbourg — Place Broglie", lat: 48.5836, lng: 7.7457, location: "Place Broglie (site of the Strasbourg Christmas Market, oldest in France), Strasbourg", image: "assets/img/mapstr/place-broglie.webp", credit: "Photo: Tristan Schmurr from Luxembourg, Luxembourg / Wikimedia Commons (CC BY 2.0)", photoSrc: "https://www.pexels.com/photo/picturesque-half-timbered-houses-in-strasbourg-38817543/", units: [{ num: 14, fr: "Organiser un programme + gérer un désaccord + un imprévu", en: "Negotiate a 3-step itinerary with a diverging view, use concessive connectors, then handle an unexpected problem and agree on a plan B." }, { num: 15, fr: "Raconter une expérience (week-end) + relancer", en: "Narrate a past weekend in 4 sentences using the passé composé, express a reaction, and hand the floor back et toi, tu as fait quoi ?" }] },
          { id: "cathedrale-strasbourg", city: "Strasbourg — Cathédrale", lat: 48.5818, lng: 7.7507, location: "Cathédrale Notre-Dame de Strasbourg (pink Vosges sandstone Gothic cathedral, 142m spire)", image: "assets/img/mapstr/cathedrale-strasbourg.webp", credit: "Photo: Diliff / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "https://unsplash.com/photos/strasbourg-cathedral-france-CE5xHM3-vbw", units: [{ num: 16, fr: "Comparer + recommander selon un critère", en: "Compare two destinations on multiple criteria, recommend one conditionally, and introduce a counterpoint en revanche." }] },
          { id: "reims-cathedrale", city: "Reims — Cathédrale", lat: 49.2533, lng: 4.0339, location: "Cathédrale Notre-Dame de Reims (royal coronation cathedral, UNESCO World Heritage)", image: "assets/img/mapstr/reims-cathedrale.webp", credit: "Photo: The Crazy Tourist (thecrazytourist.com) / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://unsplash.com/photos/people-walking-near-brown-concrete-building-during-daytime-_xAUCK4KtHo", units: [{ num: 17, fr: "Acheter au marché + négocier un prix", en: "Request a specific quantity of a product, ask a quality question, and attempt a soft negotiation — vous me faites un petit prix ? Discover the culture of French outdoor markets." }] },
          { id: "place-erlon", city: "Reims — Place d'Erlon", lat: 49.2580, lng: 4.0321, location: "Place d'Erlon (Reims's lively pedestrian main square, cafés and brasseries)", image: "assets/img/mapstr/place-erlon.webp", credit: "Photo: Mathieu Kappler / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://unsplash.com/photos/a-city-square-with-a-clock-tower-in-the-middle-of-it-a1-Jho3HRnc", units: [{ num: 18, fr: "Signaler un problème + demander une solution", en: "Signal a problem at a restaurant or shop calmly, request a remedy, and conclude the interaction once the issue is resolved." }] },
      ...
      },
      {
        ...
        pins: [
          { id: "lsf-beg-intro", city: "Paris — Place de la République", lat: 48.8674, lng: 2.3633, location: "Place de la République (bustling central square), 11e arrondissement", image: "assets/img/mapstr/lsf-beg-intro.webp", credit: "Photo: Léopold Morice / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "https://www.pexels.com/photo/close-up-of-carved-statues-on-the-place-de-la-republique-in-paris-france-15792511/", units: [{ num: 1, fr: "Bonjour, je m'appelle…", en: "Introduce yourself to a stranger: give your first name, nationality, and home city. Respond to et vous ? without hesitation in a 2-turn mini-dialogue." }] },
          { id: "lsf-beg-marche", city: "Paris — Marché Bastille", lat: 48.8533, lng: 2.3701, location: "Marché Bastille (Boulevard Richard-Lenoir), 11e arrondissement — one of Paris's finest outdoor markets", image: "assets/img/mapstr/lsf-beg-marche.jpg", credit: "Photo: Francisco Anzola / Wikimedia Commons (CC BY 2.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 2, fr: "Au marché et à la boulangerie", en: "Buy three products, ask for the price, and close the transaction. Use je voudrais [produit], s'il vous plaît, c'est combien ?, voilà, merci !" }] },
          { id: "lsf-beg-metro", city: "Paris — Châtelet", lat: 48.8597, lng: 2.3470, location: "Châtelet metro station (hub of the Paris metro, 1er arrondissement)", image: "assets/img/mapstr/lsf-beg-metro.jpg", credit: "Photo: Moonik / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 3, fr: "Comment y aller ?", en: "Ask for and understand a simple itinerary, then buy a metro ticket. Use pour aller à [lieu], s'il vous plaît ? and understand à gauche / à droite / tout droit." }] },
          { id: "lsf-beg-restaurant", city: "Paris — Montparnasse", lat: 48.8420, lng: 2.3213, location: "Brasserie du Dôme, Boulevard du Montparnasse, 14e arrondissement", image: "assets/img/mapstr/lsf-beg-restaurant.webp", credit: "Photo: Godot13 / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://www.pexels.com/photo/street-scene-at-la-rotonde-brasserie-paris-33935397/", units: [{ num: 4, fr: "Au café, au restaurant", en: "Place a full order, handle a mistake — ce n'est pas ce que j'ai commandé — and ask for the bill. A complete role-play with no script on the second pass." }] },
          { id: "lsf-beg-appart", city: "Paris — Oberkampf", lat: 48.8647, lng: 2.3726, location: "Residential apartment building, Rue Oberkampf, 11e arrondissement", image: "assets/img/mapstr/lsf-beg-appart.jpg", credit: "Photo: Fred Romero from Paris, France / Wikimedia Commons (CC BY 2.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 5, fr: "Chez moi", en: "Describe your home in 3–5 sentences: name the rooms, locate them with prepositions, and give the floor number. Answer 2 follow-up questions without a script." }, { num: 6, fr: "⚡ Speed dating : Bienvenue en France !", en: "Chain the 5 speech acts from Units 1–5 in a speed dating format with at least one unexpected prompt per situation." }] },
          ...
          { id: "lsf-beg-preferences", city: "Paris — Buttes-Chaumont", lat: 48.8799, lng: 2.3819, location: "Parc des Buttes-Chaumont (dramatic 19th-century park, temple island), 19e arrondissement", image: "assets/img/mapstr/lsf-beg-preferences.jpg", credit: "Photo: Guilhem Vellut from Paris, France / Wikimedia Commons (CC BY 2.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 8, fr: "Ce que j'aime, ce que je déteste", en: "Exchange preferences on food, activities, and places over 5 turns. Use the full opinion scale and close with a short monologue: 3 things you love about France." }] },
          { id: "lsf-beg-pharmacie", city: "Paris — Pharmacy", lat: 48.8586, lng: 2.3378, location: "Grande Pharmacie de Paris, Saint-Germain-des-Prés, 6e arrondissement", image: "assets/img/mapstr/lsf-beg-pharmacie.jpg", credit: "Photo: Jesús Gorriti from Madrid, Spain / Wikimedia Commons (CC BY-SA 2.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 9, fr: "Je ne me sens pas bien", en: "Describe two symptoms and request medication at a pharmacy. Use j'ai mal à la tête / au ventre, j'ai de la fièvre. Understand simple pharmacist instructions." }, { num: 10, fr: "⚡ Speed dating : Mon premier mois en France", en: "Final consolidation of all LSF Beginner speech acts in free production. Five situations drawn at random from Units 1–9, each with at least one unexpected prompt." }] }
        ],
      ...
      },
      {
        ...
        pins: [
          ...
          { id: "lsf-el-problem", city: "Paris — Hôtel", lat: 48.8636, lng: 2.3264, location: "Hôtel de l'Opéra area (9e arrondissement) — signalling a problem at reception", image: "assets/img/mapstr/lsf-el-problem.jpg", credit: "Photo: Philippe Alès / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 2, fr: "Il y a un problème…", en: "Signal a problem clearly, make a polite request using est-ce que vous pouvez ?, and hold your ground if the first response is a refusal. Handle at least 2 unexpected twists." }] },
          { id: "lsf-el-rdv", city: "Paris — Cabinet médical", lat: 48.8706, lng: 2.3290, location: "Cabinet médical, 9e arrondissement (phone appointment with a French doctor or specialist)", image: "assets/img/mapstr/lsf-el-rdv.webp", credit: "Photo: Polymagou / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "https://www.pexels.com/photo/stunning-architectural-facade-of-paris-opera-house-30133213/", units: [{ num: 3, fr: "Prendre rendez-vous", en: "Make an appointment by phone: introduce yourself, state the purpose of your call, and negotiate an alternative slot if the first is unavailable." }] },
          { id: "lsf-el-sortir", city: "Paris — Opéra Garnier", lat: 48.8719, lng: 2.3316, location: "Opéra Garnier (Palais Garnier), Place de l'Opéra, 9e arrondissement", image: "assets/img/mapstr/lsf-el-sortir.jpg", credit: "Photo: Chabe01 / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 4, fr: "Sortir à Paris", en: "Propose an outing with a day and venue, reserve tickets, and accept or decline with a reason. Agree on a meeting point and time. Discover the cultural offer of French cities." }, { num: 6, fr: "⚡ Speed dating : La vie à Paris", en: "Chain the 5 speech acts from Units 1–5 in a speed dating format with one unexpected prompt per situation and no written support." }] },
          { id: "lsf-el-work", city: "Paris — La Défense", lat: 48.8924, lng: 2.2386, location: "La Défense (Paris business district — professional introductions and project talk)", image: "assets/img/mapstr/lsf-el-work.webp", credit: "Photo: Dimitri Destugues / Wikimedia Commons (CC BY-SA 3.0)", photoSrc: "https://unsplash.com/s/photos/la-defense-paris", units: [{ num: 5, fr: "Mon travail, mes projets", en: "Give a 5-sentence semi-formal professional introduction: name your job and sector, describe your work environment, and talk about a near-future project using je vais + infinitif." }] },
          { id: "lsf-el-recit", city: "Paris — Musée d'Orsay", lat: 48.8600, lng: 2.3266, location: "Musée d'Orsay (Impressionist and Post-Impressionist collections), 7e arrondissement", image: "assets/img/mapstr/lsf-el-recit.jpg", credit: "Photo: Ibex73 / Wikimedia Commons (CC BY-SA 4.0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 7, fr: "Je t'explique…", en: "Narrate a recent event in 4–5 sentences using the passé composé with avoir. Sequence with d'abord… et ensuite…, and respond to one off-script question." }] },
