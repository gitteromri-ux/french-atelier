    ...
    courses: [
      {
        ...
        pins: [
          ...
          { id: "bastille", city: "Paris — Bastille", lat: 48.8533, lng: 2.3692, location: "Place de la Bastille, 11e/12e arrondissement", image: "assets/img/mapstr/bastille.jpg", credit: "Photo: Jebulon / Wikimedia Commons (CC0)", photoSrc: "Mapstr map — https://mapstr.com/user/thefrench.atelier", units: [{ num: 16, fr: "Commander — Réactivation", en: "Revisit ordering sequences at a faster pace: respond to Autre chose ? in three different ways." }, { num: 17, fr: "Commander — Je prends… + l'addition", en: "Use je prends, react to an unavailable item, and ask for the bill. Fluent end-to-end restaurant interaction." }] },
